...
# Run the script
#srun --export=ALL 
python td3.py --threshold_pos 0.001 --threshold_ori 5 --action_type euler --maxforce 3.5 --softtissue "$TISSUE" --num_springs "$NUM_SPRINGS" --youngs_modulus "$YM" --contact_type 0 --ran $TASK_ID
